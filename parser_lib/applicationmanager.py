...
def whitelist_name():
    ...
    whitelist.append("KakaoTalk")
    whitelist.append("카카오페이지")
    whitelist.append("아이러브파스타")
    whitelist.append("메시지")
    whitelist.append("Messages")
    whitelist.append("S헬스")
    whitelist.append("Contacts")
    whitelist.append("전화")
    whitelist.append("Phone")
    whitelist.append("Camera")
    whitelist.append("Omni Swipe")
    whitelist.append("Maps")
    whitelist.append("Chrome")
    whitelist.append("LINE")
    whitelist.append("Naver Map")
    whitelist.append("전화")
    ...
    whitelist.append("갤러리")
    whitelist.append("Omni Swipe")
    whitelist.append("후후")
    whitelist.append("Clock")
    whitelist.append("GroupMe")
    whitelist.append("10B wives")
    whitelist.append("코레일톡")
    whitelist.append("Gallery")
    whitelist.append("Photo Editor")
    whitelist.append("Music")
    whitelist.append("카메라")
    whitelist.append("Google 앱")
    whitelist.append("Gmail")
    whitelist.append("한컴오피스 뷰어")
    whitelist.append("S플래너")
    whitelist.append("T전화")
    whitelist.append("T전화 통화")
    whitelist.append("스마트청구서")
    whitelist.append("날씨")
    whitelist.append("인터넷")
    whitelist.append("메모")
    whitelist.append("위비톡")
    whitelist.append("비디오 플레이어")
